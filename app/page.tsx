...
export default function Home(){
  ...
  const start=()=>{setMarket(createMarketProfile(Math.floor(Math.random()*1_000_000_000)));setScreen('game');setPhase('planning')};
